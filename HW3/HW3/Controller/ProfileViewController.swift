...
class ProfileViewController: UIViewController {
    ...
    private let profileModel = Profile(name: "Алия Сатбакова", age: "31", education: "Высшее экономическое", cityOfResidence: "Новосибирск", hometown: "Иркутск", photo: "myAvatar")
